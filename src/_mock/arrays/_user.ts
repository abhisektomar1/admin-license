...
export const _userList = [...Array(0)].map((_, index) => ({
  id: _mock.id(index),
  fid: _mock.id(index),
  title: _mock.name.fullName(index),
  key:_mock.name.fullName(index),
  caseNo: _mock.name.fullName(index),
  category: _mock.name.fullName(index),
  status: randomInArray([true, false]),
  description : _mock.name.fullName(index),
  name:_mock.name.fullName(index),
  email:_mock.name.fullName(index),
  phone:_mock.name.fullName(index),
  startDateTime:_mock.id(index),
  endDateTime:_mock.id(index),
  symptoms:_mock.name.fullName(index),
  start:_mock.name.fullName(index),
  end:_mock.name.fullName(index),
}));
